...
              <input 
                type="checkbox" 
                checked={todo.completed}  // Ensure the checkbox reflects state
                className="form-check-input me-2 float-start"
                onChange={(e) => {
                  const updatedTodo = { ...todo, completed: e.target.checked };
                  setTodos(todos.map(t => t.id === todo.id ? updatedTodo : t)); // Update state immediately
                  updateTodo(updatedTodo); // Persist change to backend
                }}
              />
        
              {!todo.editing ? (
